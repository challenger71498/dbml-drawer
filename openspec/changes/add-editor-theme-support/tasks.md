...
- [x] 1.3 Implement page-local code editor theme state that reads and writes the selected code editor mode from local browser storage with a safe fallback to `system`.
...
- [x] 2.2 Add an accessible Light/Dark/System code editor theme mode control near the workspace theme control.
...
- [x] 4.4 Verify changing the code editor theme does not recreate or lose the current DBML document state, diagnostics markers, or source reveal ref behavior.
...
- [x] 5.4 Add DBML code editor tests verifying Monaco receives VS Code Light 2026 and Gruvbox Material dark medium theme ids for resolved light and dark.
