...
- [x] 2.3 Define pure white light primitive color tokens by reinterpreting the dark theme palette semantics for a light surface rather than copying the current light colors verbatim.
- [x] 2.4 Define light, light-solarized, and dark semantic tokens for text, surfaces, borders, controls, source accent, destination accent, relation line, diagnostics, and editor status colors.
- [x] 2.5 Define light, light-solarized, and dark component tokens for editor chrome, sidebar shell, DBML diagram tables, relation edges, selection highlights, diagnostics panels, and Monaco theme values.
...
- [x] 3.3 Generate or assemble light, light-solarized, and dark Monaco theme values from generated TypeScript tokens.
...
- [x] 4.2 Replace light, light-solarized, and dark editor workspace CSS custom property values in `EditorPage.module.css` with generated token variables.
- [x] 4.3 Replace diagram table, column, handle, relation, and selection highlight values with generated token values for all themes.
- [x] 4.4 Replace light, light-solarized, and dark Monaco theme color definitions in `editor-theme.ts` with generated token values.
- [x] 4.5 Remove duplicated raw palette values from editor CSS modules and TypeScript rendering code.

## 5. Tests and Verification

- [x] 5.1 Add or update tests proving light, light-solarized, and dark workspace theme selection still applies the expected theme attributes/classes.
- [x] 5.2 Add or update tests proving light, light-solarized, and dark DBML code editor theme selection still registers and uses the generated Monaco themes.
